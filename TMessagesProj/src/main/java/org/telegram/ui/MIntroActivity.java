...
//        TODO We had removed tabs. So find another way to make To do that...
//        TabLayout tabLayout = findViewById(R.id.m_intro_tabs);
...
//                Intro.setScrollOffset(offset);
    ...
    public class MIntroCategoryAdapter extends FragmentPagerAdapter {
        ...
        public MIntroCategoryAdapter(FragmentManager fm) {
            super(fm);
        }
